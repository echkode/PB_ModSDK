...
namespace Area
{
    ...
    sealed class AreaSceneVolumeModePanel : AreaSceneModePanel
    {
        ...
        void DrawDebugInfo (AreaVolumePoint pointHovered)
        {
            ...
            GUILayout.Label (CompactFormat ("N", pointHovered.pointsInSpot[WorldSpace.Compass.North]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("W", pointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.West]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("S", pointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.South]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("E", pointHovered.pointsInSpot[WorldSpace.Compass.East]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("SW", pointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.SouthWest]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("NE", pointHovered.pointsInSpot[WorldSpace.Compass.NorthEast]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("U", pointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.Up]), EditorStyles.miniLabel);
            GUILayout.Label (CompactFormat ("D", pointHovered.pointsInSpot[WorldSpace.Compass.Down]), EditorStyles.miniLabel);
