...
namespace Area
{
    ...
    sealed class TerrainShapeModePanelPointDisplay : SelfDrawnGUI
    {
        ...
        public string terrainOffset => "Terrain offset: " + (hasOffset
            ? point.pointsWithSurroundingSpots[WorldSpace.Compass.Up].terrainOffset.ToString ("+0.##;-0.##")
            : "<none>");
        ...
        bool hasOffset => hasPoint && point.pointsWithSurroundingSpots[WorldSpace.Compass.Up] != null && point.pointsWithSurroundingSpots[WorldSpace.Compass.Up].terrainOffset != 0f;
