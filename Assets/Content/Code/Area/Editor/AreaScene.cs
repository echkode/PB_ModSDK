...
namespace Area.Scene
{
    ...
    static class SpotsByFace
    {
        ...
        public static readonly Dictionary<int, int[]> Map = new Dictionary<int, int[]> ()
        {
            ...
            {
                WorldSpace.Compass.SpotSelf,
                WorldSpace.Compass.West,
                WorldSpace.Compass.SouthWest,
                WorldSpace.Compass.South,
                WorldSpace.Compass.Up,
                WorldSpace.Compass.UpWest,
                WorldSpace.Compass.UpSouthWest,
                WorldSpace.Compass.UpSouth,
            },
