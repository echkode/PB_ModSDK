    ...
    sealed class AreaSceneTransferMode : AreaSceneMode
    {
        ...
        void DrawGroundingStilts (Vector3 targetPosA, Vector3 targetPosB)
        {
            ...
            var offsets = new[]
            {
                ...
                new Vector3 (0f, 0f, offsetZ * TilesetUtility.blockAssetSize),
                new Vector3 (offsetX * TilesetUtility.blockAssetSize, 0f, offsetZ * TilesetUtility.blockAssetSize),
                new Vector3 (offsetX * TilesetUtility.blockAssetSize, 0f, 0f),
            };
            var cutoffDistance = (am.clipboard.clipboardBoundsSaved.y - 1) * TilesetUtility.blockAssetSize + 0.1f;
