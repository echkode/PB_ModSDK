...
namespace Area
{
    ...
    sealed class AreaSceneDamageMode : AreaSceneMode
    {
        ...
        public void DrawSceneMarkup (Event e, System.Action repaint)
        {
            ...
            const float halfBlockPlusCM = TilesetUtility.blockAssetHalfSize + 0.01f;
            ...
            for (var i = startIndex; i < stopIndex; i += 1)
            {
                ...
                var pointAbove = point.pointsWithSurroundingSpots[WorldSpace.Compass.Up];
                var pointLast = point;
                ...
                while (pointAbove != null && pointAbove.pointPositionIndex.y >= damageRestrictionDepth)
                {
                    ...
                    pointAbove = pointAbove.pointsWithSurroundingSpots[WorldSpace.Compass.Up];
                }
                ...
                while (avp != null)
                {
                    ...
                    avp = avp.pointsWithSurroundingSpots[WorldSpace.Compass.Up];
                }
        ...
        void ToggleDestructible (AreaVolumePoint point)
        {
            ...
            var pointNeighborDown = point.pointsInSpot[WorldSpace.Compass.Down];
            var pointsChanged = 0;
            while (pointNeighborDown != null)
            {
                ...
                pointNeighborDown = pointNeighborDown.pointsInSpot[WorldSpace.Compass.Down];
                pointsChanged += 1;
            }
