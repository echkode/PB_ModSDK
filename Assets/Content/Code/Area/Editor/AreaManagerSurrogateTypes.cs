...
namespace Area
{
    ...
    sealed class SliceControls
    {
        ...
        {
            get => bb.am.sliceDepth;
            set
            {
                bb.am.sliceDepth = Mathf.Clamp (value, 0, sliceDepthLimit);
                bb.am.UpdateSlicing ();
                RedrawSceneView ();
            }
        }
        ...
        {
            bb.am.SetVolumeDisplayMode (!bb.am.displayOnlyVolume);
            RedrawSceneView ();
        }
        ...
        {
            bb.am.displayProps = !bb.am.displayProps;
        ...
        {
            bb.am.sliceEnabled = !bb.am.sliceEnabled;
            bb.am.UpdateSlicing ();
            RedrawSceneView ();
        }

        bool showSliceControls => bb?.am.sliceEnabled ?? false;
        bool enable => bb.editingMode != EditingMode.Layers;
        string buttonLabelVolumeView => (bb?.am.displayOnlyVolume ?? false) ? "Show everything" : "Show only volume";
        string buttonLabelPropView => (bb?.am.displayProps ?? false) ? "Hide props" : "Show props";
        string buttonLabelSlicing => (bb?.am.sliceEnabled ?? false) ? "Disable slicing" : "Enable slicing";
