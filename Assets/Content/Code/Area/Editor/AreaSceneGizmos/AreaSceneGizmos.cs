    ...
    class AreaSceneGizmos
    {
        ...
        */
        ...
        public void DrawWireframesForVolume (bool shift)
        {
            ...
            const float cubeShrink = TilesetUtility.blockAssetHalfSize * 0.93f;
            const float bracketShrink = TilesetUtility.blockAssetHalfSize * 0.87f;
            ...
            if (shift)
            {
                var neighborUp = lastPointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.Up];
                if (neighborUp != null)
                {
                    var surfacePos = lastPointHovered.pointPositionLocal + Vector3.up * TilesetUtility.blockAssetHalfSize;
                    var offset = neighborUp.terrainOffset * TilesetUtility.blockAssetSize;
                    ...
                    if (Mathf.Abs (offset) > 0.05f)
                    {
                        ...
                        DrawAALine (surfacePos, surfacePos + Vector3.up * offset, TilesetUtility.blockAssetSize, color);
                    }
                }
                return;
            }
        ...
        void DrawAreaBorder ()
        {
            ...
            var boundsScaled = bb.am.boundsFull * Mathf.RoundToInt (TilesetUtility.blockAssetSize);
        ...
        void DrawWireframeCubeForSpot(AreaVolumePoint lastSpotHovered)
        {
            ...
            const float positiveLineLength = TilesetUtility.blockAssetSize * 1.25f;
            var offset = Vector3.up * 0.1f;
            var origin = lastSpotHovered.pointPositionLocal + offset;

            var neighborEast = lastSpotHovered.pointsInSpot[WorldSpace.Compass.East];
            ...
            var neighborNorth = lastSpotHovered.pointsInSpot[WorldSpace.Compass.North];
            ...
            var neighborWest = lastSpotHovered.pointsWithSurroundingSpots[WorldSpace.Compass.West];
            if (neighborWest != null)
            {
                DrawZTestLine (origin, neighborWest.pointPositionLocal + offset, Colors.Axis.XNeg);
            }

            var neighborSouth = lastSpotHovered.pointsWithSurroundingSpots[WorldSpace.Compass.South];
        ...
        void DrawSurfaceDirectionIndicator (AreaVolumePoint lastSpotHovered)
        {
            ...
            DrawZTestLine (lastSpotHovered.instancePosition, lastSpotHovered.instancePosition + direction * TilesetUtility.blockAssetSize, dirColor);
        ...
        {
            var lastPointHovered = bb.lastPointHovered;
            var neighborEast = lastPointHovered.pointsInSpot[WorldSpace.Compass.East];
            var neighborWest = lastPointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.West];
            ...
            var neighborNorth = lastPointHovered.pointsInSpot[WorldSpace.Compass.North];
            var neighborSouth = lastPointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.South];
            ...
            var neighborDown = lastPointHovered.pointsInSpot[WorldSpace.Compass.Down];
            var neighborUp = lastPointHovered.pointsWithSurroundingSpots[WorldSpace.Compass.Up];
        ...
        void GetQuadCornersForSpot (AreaVolumePoint spot, Vector3 direction)
        {
            ...
            var corners = spotQuadCornerMap[compass];
        ...
        static readonly Dictionary<int, Vector3[]> spotQuadCornerMap = new Dictionary<int, Vector3[]> ()
        {
            ...
            {
                new Vector3 (TilesetUtility.blockAssetHalfSize, 0f, TilesetUtility.blockAssetHalfSize),
                new Vector3 (-TilesetUtility.blockAssetHalfSize, 0f, TilesetUtility.blockAssetHalfSize),
                new Vector3 (-TilesetUtility.blockAssetHalfSize, 0f, -TilesetUtility.blockAssetHalfSize),
                new Vector3 (TilesetUtility.blockAssetHalfSize, 0f, -TilesetUtility.blockAssetHalfSize),
            },
            ...
            {
                new Vector3 (-TilesetUtility.blockAssetHalfSize, TilesetUtility.blockAssetHalfSize, 0f),
                new Vector3 (TilesetUtility.blockAssetHalfSize, TilesetUtility.blockAssetHalfSize, 0f),
                new Vector3 (TilesetUtility.blockAssetHalfSize, -TilesetUtility.blockAssetHalfSize, 0f),
                new Vector3 (-TilesetUtility.blockAssetHalfSize, -TilesetUtility.blockAssetHalfSize, 0f),
            },
            ...
            {
                new Vector3 (0f, TilesetUtility.blockAssetHalfSize, TilesetUtility.blockAssetHalfSize),
                new Vector3 (0f, TilesetUtility.blockAssetHalfSize, -TilesetUtility.blockAssetHalfSize),
                new Vector3 (0f, -TilesetUtility.blockAssetHalfSize, -TilesetUtility.blockAssetHalfSize),
                new Vector3 (0f, -TilesetUtility.blockAssetHalfSize, TilesetUtility.blockAssetHalfSize),
            },
